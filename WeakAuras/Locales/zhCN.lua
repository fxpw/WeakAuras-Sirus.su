...
https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000不再支持未过滤的 COMBAT_LOG_EVENT_UNFILTERED|r 未经过滤的 COMBAT_LOG_EVENT_UNFILTERED 已被禁用，因为它对性能影响很大。更多信息：https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Custom-Triggers#events"
...
https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Protected-Frames]=] ] = "无法在战斗中更改安全框架。请查阅：https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Protected-Frames"
L["Capped"] = "已达上限"
L["Cast"] = "施法"
L["Cast Bar"] = "施法条"
L["Cast Failed"] = "施法失败"
...
https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Protected-Frames]=] ] = "错误：'%s'创建了一个安全克隆。我们建议删除此光环。请查阅：https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Protected-Frames"
...
https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Protected-Frames]=] ] = "检测到安全框架。请查阅：https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Protected-Frames"
L["Select Frame"] = "选择框体"
...
L["WeakAuras has detected empty settings. If this is unexpected, ask for assistance on https://discord.gg/UXSc7nt."] = "WeakAuras 检测到设置项为空。如果这是意料之外的，请在 https://discord.gg/UXSc7nt 上寻求帮助。"
