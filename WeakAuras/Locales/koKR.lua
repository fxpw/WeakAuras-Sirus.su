...
https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000필터가 없는 COMBAT_LOG_EVENT_UNFILTERED 이벤트의 지원은 중단됐습니다|r 필터가 없는 COMBAT_LOG_EVENT_UNFILTERED 이벤트는 성능 소모가 심해 사용할 수 없습니다. 자세한 정보: https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Custom-Triggers#events"
...
https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Protected-Frames]=] ] = [=[전투 중에는 보안 프레임을 변경할 수 없습니다. 자세한 정보:
...
https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Protected-Frames]=] ] = [=['%s' 오류가 보안 요소의 복사본을 생성했습니다. 이 위크오라는 삭제할 것을 권장합니다. 자세한 정보:
https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Protected-Frames]=]
...
L["Id"] = "ID"
L["ID"] = "ID"
L["If you require additional assistance, please open a ticket on GitHub or visit our Discord at https://discord.gg/UXSc7nt!"] = "더 많은 도움이 필요하다면 GitHub에서 티켓을 열거나 저희 Discord (https://discord.gg/UXSc7nt)를 방문해 주세요!"
L["Ignore Dead"] = "죽음 무시"
...
https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Protected-Frames]=] ] = [=[보안 프레임이 감지됐습니다. 자세한 정보:
https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Protected-Frames]=]
...
L["WeakAuras has detected empty settings. If this is unexpected, ask for assistance on https://discord.gg/UXSc7nt."] = "WeakAuras에서 빈 설정이 감지되었습니다. 예상치 못한 상황이라면 https://discord.gg/UXSc7nt에서 도움을 요청해 주세요."
