...
https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000Поддержка нефильтрованного COMBAT_LOG_EVENT_UNFILTERED устарела|r COMBAT_LOG_EVENT_UNFILTERED без фильтра отключены, так как это очень затратно по производительности. Подробнее: https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Custom-Triggers#events"
...
https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Protected-Frames]=] ] = "Невозможно изменить защищённый кадр во время боя. Подробная информация на странице: https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Protected-Frames"
...
https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Protected-Frames]=] ] = "Ошибка при возвращении в пул клона индикации %s, поскольку кадр защищён. Советуем удалить эту индикацию. Подробная информация на странице: https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Protected-Frames"
...
https://github.com/NoM0Re/WeakAuras-WotLK/wiki/Protected-Frames]=] ] = [=[Обнаружен защищённый кадр. Подробная информация на странице:
